...
use couchbasetest\stubs\FakeCouchbaseCluster;
use oat\generis\test\GenerisPhpUnitTestRunner;

/**
 * Class CouchbasePersistenceTest
 *
 * TestCase for {@link CouchbaseDriver} class
 *
...
class CouchbasePersistenceTest extends GenerisPhpUnitTestRunner{
    ...
    {
        $mock = $this->getMockBuilder('oat\\couchbase\\CouchbaseDriver')
    ...
    /**
     * Positive test for {@link CouchbaseDriver::connect}
     *
    ...
    /**
     * Negative test for {@link CouchbaseDriver::connect}: invalid cluster
     *
    ...
    /**
     * Negative test for {@link CouchbaseDriver::connect}: empty cluster
     *
     * @expectedException \common_exception_PersistenceError
    ...
    /**
     * Negative test for {@link CouchbaseDriver::connect}: broken cluster
     *
     * @expectedException \common_exception_PersistenceError
    ...
    /**
     * Negative test for {@link CouchbaseDriver::connect}: invalid bucket
     *
     * @expectedException \common_exception_PersistenceError
    ...
    /**
     * Negative test for {@link CouchbaseDriver::connect}: invalid bucket password
     *
     * @expectedException \common_exception_PersistenceError
    ...
    /**
     * Negative test for {@link CouchbaseDriver::connect}: empty bucket
     *
     * @expectedException \common_exception_PersistenceError
    ...
    /**
     * Negative test for {@link CouchbaseDriver::connect}: broken bucket
     *
     * @expectedException \common_exception_PersistenceError
    ...
    /**
     * Positive test for {@link CouchbaseDriver::set}
     *
     * @param mixed $value
    ...
    /**
     * Positive test for {@link CouchbaseDriver::get}
     *
     * @param mixed $value
     * @dataProvider insertedDataProvider
     */
    ...
    /**
     * Negative test for {@link CouchbaseDriver::get}
     */
    ...
    /**
     * Positive test for {@link CouchbaseDriver::exists}
     */
    ...
    /**
     * Negative test for {@link CouchbaseDriver::exists}
     */
    ...
    /**
     * Positive test for {@link CouchbaseDriver::del}
     */
    ...
    /**
     * Negative test for {@link CouchbaseDriver::del}
     */
    ...
    /**
     * Buggy bucket test for {@link CouchbaseDriver::set}
     *
     * @expectedException \common_exception_PersistenceError
    ...
    /**
     * Buggy bucket test for {@link CouchbaseDriver::get}
     *
     * @expectedException \common_exception_PersistenceError
     * @expectedExceptionMessage General bucket error
     */
    ...
    /**
     * Buggy bucket test for {@link CouchbaseDriver::exists}
     *
     * @expectedException \common_exception_PersistenceError
     * @expectedExceptionMessage General bucket error
     */
    ...
    /**
     * Buggy bucket test for {@link CouchbaseDriver::del}
     *
     * @expectedException \common_exception_PersistenceError
     * @expectedExceptionMessage General bucket error
     */
